...
PATH_TEMPLATE_ANALITICO = ROOT_DIR + "/resources/templates/Relatorio_Analitico.xlsx"
PATH_TEMPLATE_SINTETICO = ROOT_DIR + "/resources/templates/Relatorio_Sintetico.xlsx"
